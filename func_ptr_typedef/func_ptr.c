...
typedef double( * PF)(double * dbData, int iSize);  // function pointer typedef

// return a function pointer, or the address to the function
...
int main(void) {
    ...
    c = getchar();
    printf("result is %lf\n", GetOperation(c)(dbData, iSize));  // call function with function pointer
}
